    ...
    >
      ...
      <div className="container mx-auto px-6 py-12 flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 space-y-6 md:pr-12">
          ...
          >
            Corretor Inteligente de <span className="text-gradient">Redações</span>
          </h1>
          <p 
            className={`text-lg text-gray-700 mb-8 max-w-xl
                       ...
                       ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
          >
            Otimize o processo de correção de redações com nossa ferramenta avançada de IA, 
            desenvolvida exclusivamente para professores de português do SESI-SP Sorocaba.
          </p>
          <div 
          ...
          >
            <Link to="/login">
              <Button className="sesi-button px-8 py-6 text-base">Área do Professor</Button>
            </Link>
            <Link to="/about">
  ...
  const features = [
    {
      ...
      description: "Identificação automática de erros ortográficos e gramaticais com sugestões de correção.",
      icon: "📝"
    },
    {
      title: "Exportação para Excel",
      description: "Salve as avaliações e comentários automaticamente em planilhas organizadas.",
      icon: "📊"
    },
    {
      title: "Interface Intuitiva",
      description: "Design pensado para facilitar o trabalho dos professores, com fluxo simplificado.",
      icon: "🖥️"
    },
    {
      title: "Relatórios Detalhados",
      description: "Acompanhe o desempenho dos alunos com análises e estatísticas detalhadas.",
      icon: "📈"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Nossa ferramenta foi desenvolvida para otimizar o trabalho dos professores
            de português e melhorar o processo de correção de redações.
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="hover-scale border border-gray-100 rounded-xl overflow-hidden">
  ...
  const steps = [
    {
      ...
      description: "Tire uma foto ou faça upload da redação do aluno no sistema."
    },
    {
      number: "02",
      title: "Análise Inteligente",
      description: "Nossa IA identifica erros e analisa a estrutura do texto automaticamente."
    },
    {
      number: "03",
      title: "Revisão e Comentários",
      description: "Revise as correções e adicione seus comentários personalizados."
    },
    {
      number: "04",
      title: "Exportação Automática",
      description: "Envie os resultados para uma planilha Excel organizada por turmas."
    }
  ];
    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Um processo simples e eficiente para otimizar a correção de redações.
          </p>
        </div>
          ...
          <div className="space-y-12 relative">
            {steps.map((step, index) => (
              <div key={index} className={`flex flex-col md:flex-row items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                ...
                <div className={`md:w-1/2 ${index % 2 === 0 ? 'md:pl-12' : 'md:pr-12'} text-center md:text-left ${index % 2 === 1 ? 'md:text-right' : ''}`}>
...
const TestimonialsSection = () => {
  const testimonials = [
    {
      quote: "Esta ferramenta revolucionou meu processo de correção, poupando horas de trabalho manual.",
      author: "Maria Lucia",
      role: "Professora de Português"
    },
    {
      quote: "A precisão da análise de texto e a facilidade de exportar dados para planilhas é impressionante.",
      author: "Carlos Silva",
      role: "Coordenador Pedagógico"
    },
    {
      quote: "Consegui reduzir pela metade o tempo que gastava com correções, sem perder a qualidade da avaliação.",
      author: "Ana Beatriz",
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Veja o que os professores do SESI-SP estão falando sobre nossa ferramenta.
          </p>
        </div>
    ...
    <section className="py-20 bg-sesi-red text-white">
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-lg opacity-90 max-w-2xl mx-auto mb-8">
          Junte-se aos professores que já estão otimizando seu processo de correção
          de redações com nossa ferramenta inteligente.
        </p>
        <Link to="/login">
          <Button className="bg-white text-sesi-red hover:bg-gray-100 font-medium rounded-md px-8 py-6 text-base
