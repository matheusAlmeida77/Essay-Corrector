...
const DetailedHighlightedText: React.FC<DetailedHighlightedTextProps> = ({ text, corrections }) => {
            ...
            <Tooltip key={fragment.index}>
              ...
              <TooltipContent className="max-w-sm">
                <div className="space-y-1">
                  <p className="font-bold">{getTooltipTitle(fragment.correction)}</p>
                  <p>
                  ...
                  {fragment.correction.explanation && (
                    <p>
                      <strong>Explicação:</strong> {fragment.correction.explanation}
                    </p>
                  )}
                </div>
              </TooltipContent>
