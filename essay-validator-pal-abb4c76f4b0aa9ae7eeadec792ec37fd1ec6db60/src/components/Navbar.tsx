    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <NavLink to="/upload" label="Corrigir Redações" pathname={location.pathname} />
          <NavLink to="/results" label="Resultados" pathname={location.pathname} />
...
const NavLink = ({ to, label, pathname }: { to: string; label: string; pathname: string }) => {
